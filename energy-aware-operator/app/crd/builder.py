...
try:
    from .models import EnergyAwareOrchestrationSpec, EnergyAwareOrchestrationStatus
except ImportError:
    from models import EnergyAwareOrchestrationSpec, EnergyAwareOrchestrationStatus
...
def main():
    ...
    outputs = {
        ...
        "helm_crds": project_root / "charts" / "energy-aware-operator" / "crds" / "energy-aware-orchestration-crd.yaml",
    }
